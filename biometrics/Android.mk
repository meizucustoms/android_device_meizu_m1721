...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.biometrics.fingerprint@2.0-service.meizu_m1721
LOCAL_INIT_RC := android.hardware.biometrics.fingerprint@2.0-service.meizu_m1721.rc
